...
const Contact = () => {
  return (
    <section
      id="contact"
      className="min-h-screen flex flex-col pt-[15%] gap-10 md:w-[75%] 2xl:w-[50%] xl:px-10 text-brown-5 pb-10 z-10"
    >
      ...
      <p className="text-center text-xl">
        If you think I would be a great fit to collaborate with, send me a
